                ...
                for (var i = 0; i < values.length; i++) {
                    ...
                    if(values[i][3] !== 'icon')
                    {
                        ...
                        if(JSON.parse(values[i][0]).geometry.type=="Point")
                        {
                            ...
                            //var long =  JSON.parse(values[i][1]).geometry.coordinates[0]
                    ...
                    else
                    {
                        ...
                        //customPopup.innerHTML = '<i class="fa fa-trash-o trashDelete" style="font-size:large" id="'+ values[i][1] + '" aria-hidden="true"></i>';
